...
class GetSortedCurrencyListUseCaseImplTest {
    private lateinit var usecase: GetSortedCurrencyListUseCase
    ...
    fun testGetSortedCurrencyList_shouldReturnFromRepository() {
        runBlockingTest {
            ...
            usecase = GetSortedCurrencyListUseCaseImpl(fakeRepository, TestCoroutineDispatcher())

            // When
            val result = usecase.invoke()

            // Then
            assertEquals(result.peekData, modelList.sortedBy { it.name })
        }
    }
